    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, AuthenticationProvider authProvider) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET,"/api/comments/product/{productId}").permitAll()
                .requestMatchers(HttpMethod.POST, "/api/comments").authenticated()
                .requestMatchers(HttpMethod.GET, "/api/users/{id}").authenticated()
                .requestMatchers(HttpMethod.PUT, "/api/users/{id}").authenticated()
                .requestMatchers(HttpMethod.GET, "/api/marcas/**").authenticated()
                .requestMatchers(HttpMethod.POST, "/api/marcas").authenticated()
                .requestMatchers(HttpMethod.PUT, "/api/marcas/**").authenticated()
